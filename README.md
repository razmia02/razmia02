...
- **Whole Genome (WGS) and Whole Exome Sequencing (WES) Analysis**  
  ...
  - Clinical report generation and pipeline optimization  
- **Bulk RNA-seq**: Differential gene expression and non-coding RNA analysis  
- **Single-cell RNA-seq (scRNA-seq)**: Familiar with 10x Genomics and Seurat  
